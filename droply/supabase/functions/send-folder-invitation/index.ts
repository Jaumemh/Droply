...
serve(async (req) => {
  ...
  try {
              ...
              <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                  ...
                  <td style="background: linear-gradient(135deg, #10B981 0%, #059669 100%); padding: 40px 30px; text-align: center;">
                    <div style="background-color: #ffffff; width: 80px; height: 80px; margin: 0 auto 20px; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                      <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M20 6H12L10 4H4C2.9 4 2.01 4.9 2.01 6L2 18C2 19.1 2.9 20 4 20H20C21.1 20 22 19.1 22 18V8C22 6.9 21.1 6 20 6Z" fill="#10B981"/>
                      </svg>
                    </div>
                    <h1 style="margin: 0; color: #ffffff; font-size: 28px; font-weight: 700;">📁 Invitación a Carpeta</h1>
                ...
                <tr>
                  <td style="padding: 40px 30px;">
                    ...
                    <p style="font-size: 16px; color: #374151; line-height: 1.6; margin: 0 0 20px;">
                      <strong style="color: #10B981;">${senderEmail}</strong> te ha invitado a acceder a una carpeta compartida en <strong>Droply</strong>:
                    </p>
                    ...
                    <div style="background-color: #f9fafb; border: 2px solid #e5e7eb; border-radius: 12px; padding: 24px; margin: 24px 0;">
                      <div style="display: flex; align-items: center; margin-bottom: 16px;">
                        ...
                        <h2 style="margin: 0; font-size: 20px; color: #111827; font-weight: 600;">${folderName}</h2>
                      </div>
                      <div style="border-top: 1px solid #e5e7eb; padding-top: 16px;">
                        <p style="margin: 0 0 8px; font-size: 14px; color: #6b7280;">
                          <strong>Permisos:</strong> <span style="color: #10B981; font-weight: 600;">${permission}</span>
                        </p>
                        <p style="margin: 0; font-size: 14px; color: #6b7280;">
                          <strong>Válido hasta:</strong> ${formattedExpiry}
                        </p>
                      </div>
                    </div>
                    ...
                    <div style="background-color: #f9fafb; padding: 12px; border-radius: 8px; margin-top: 8px; word-break: break-all;">
                      <code style="font-size: 13px; color: #059669;">${invitationLink}</code>
                    </div>
                    ...
                    <div style="border-top: 2px solid #e5e7eb; margin-top: 40px; padding-top: 24px;">
                      <p style="font-size: 13px; color: #9ca3af; line-height: 1.5; margin: 0;">
                        ⚠️ <strong>Importante:</strong> Esta invitación expira el <strong>${formattedExpiry}</strong>. Si no reconoces al remitente, puedes ignorar este correo de forma segura.
                      </p>
                    </div>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="background-color: #f9fafb; padding: 30px; text-align: center; border-top: 1px solid #e5e7eb;">
                    ...
                    <p style="margin: 0; font-size: 12px; color: #9ca3af;">
                      Plataforma segura para compartir archivos en ≤3 toques
                    </p>
                    ...
                    <p style="margin: 16px 0 0; font-size: 11px; color: #9ca3af;">
                      © ${new Date().getFullYear()} Droply. Todos los derechos reservados.
                    </p>
                  </td>
                </tr>
              </table>
    ...
    await client.send({
      from: GMAIL_USER!,
      to: to,
      subject: `📁 ${senderEmail} te invitó a una carpeta: ${folderName}`,
      content: htmlContent,
      html: htmlContent,
    });
