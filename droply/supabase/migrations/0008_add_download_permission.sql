-- Añadir 'download' al enum share_permission
alter type public.share_permission add value if not exists 'download';

-- Actualizar la función create_share_link para aceptar el parámetro de permiso
drop function if exists public.create_share_link(uuid, text);

create or replace function public.create_share_link(
  p_file_id uuid,
  p_note text default null,
  p_permission public.share_permission default 'read'
)
...
-- Actualizar la función resolve_share_token para devolver el permiso
